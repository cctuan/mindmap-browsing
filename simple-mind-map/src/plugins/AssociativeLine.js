...
class AssociativeLine {
  ...
  addLine(fromNode, toNode) {
    ...
    const fromNodeId = fromNode.getData('uid')
    let associativeLineParents = fromNode.getData('associativeLineParents') || []
    if(!associativeLineParents.some(item => item === fromNodeId)) {
      associativeLineParents.push(fromNodeId)
    }
    this.mindMap.execCommand('SET_NODE_DATA', toNode, {
      associativeLineParents
    })
